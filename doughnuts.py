...
def change_prompt():
    ...
    if (namespace == "main"):
        ...
        print(color.yellow("[check] ") + color.cyan(" Check if each webshell is alive. eg: check {timeout=2.0}"))
        ...
        print(color.yellow("[search] ") + color.cyan("Search file by glob, pattern support . * [...] . eg: search {pattern}"))
